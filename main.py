...
headers = {'Host': 'ticket.sstm.org.cn', 'Connection': 'keep-alive',
           ...
           'User-Agent': 'Mozilla/5.0 (iPhone; CPU iPhone OS 16_2 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Mobile/15E148 MicroMessenger/8.0.32(0x18002033) NetType/3G Language/zh_CN',
           'Referer': 'https://servicewechat.com/wx1d7ddce169710ba7/42/page-frame.html'}
url = 'https://ticket.sstm.org.cn/vendor/reserve/getReservePeriodListByDate.xhtml?stadiumId=69001&reservedate=2023-04-28&appId=wx1d7ddce169710ba7'
while True:
    ...
    if r.status_code != 200:
        ...
        if not data['success']:
            ...
            if data['data']['reservePeriodList'][0]['avaiablenum'] > 0 or data['data']['reservePeriodList'][1][
                ...
                requests.get('https://api.day.app/<barkToken>/有票了')
